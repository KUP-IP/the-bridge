...
//      TheBridge.entitlements (declared by this packet), AND
...
public enum RemindersModuleError: LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        switch self {
        case .accessDenied:
            return "Reminders access not granted. Enable in System Settings > Privacy & Security > Reminders for The Bridge."
