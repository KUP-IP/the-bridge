...
public actor ServerManager {
    ...
    public func setup() async -> Int {
        ...
        await LspModule.register(on: router)   // PKT-745 (v2.2 · 2.3): 16th module — lsp_* scaffold (5 dev/ tools; capability probe + workspace detection; JSON-RPC client deferred to W2)
