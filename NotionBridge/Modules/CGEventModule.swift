...
public enum CGEventModule {
    ...
    private enum CGEvErr: Error {
        ...
        func toResponse() -> Value {
            ...
            case .notTrusted:
                return .object([
                    "error": .string("capability_missing: Accessibility permissions required to post CGEvents. Open System Settings > Privacy & Security > Accessibility and grant Notion Bridge."),
