...
- Use the Software to provide a hosted or multi-user service to third parties
- Share your license with other individuals or machines
...
- Sufficient macOS permissions granted for desired functionality (see Privacy Policy §4)

The Software is **not compatible** with Intel-based Macs, earlier macOS versions, or any non-macOS operating system. We are not responsible for compatibility issues on unsupported configurations.
...
THE SOFTWARE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE SOFTWARE WILL BE UNINTERRUPTED, ERROR-FREE, OR SECURE, OR THAT DEFECTS WILL BE CORRECTED.

---

## 10. Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL KUP SOLUTIONS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, RESULTING FROM:

- YOUR USE OF OR INABILITY TO USE THE SOFTWARE
- ANY ACTIONS TAKEN BY AI AGENTS OR THIRD-PARTY MCP CLIENTS THROUGH THE SOFTWARE
- UNAUTHORIZED ACCESS TO YOUR MACHINE, DATA, OR ACCOUNTS
- ANY THIRD-PARTY CONDUCT OR CONTENT
- DAMAGE TO YOUR MAC, OPERATING SYSTEM, OR INSTALLED APPLICATIONS
- DELETION, MODIFICATION, CORRUPTION, OR LOSS OF FILES, DATA, OR DOCUMENTS
- DISRUPTION OF OR ISSUES WITH YOUR THIRD-PARTY ACCOUNTS (INCLUDING NOTION, STRIPE, OR CLOUDFLARE)
- UNINTENDED MESSAGES SENT, COMMANDS EXECUTED, OR ACTIONS PERFORMED
- ANY MACOS PERMISSION GRANTS YOU AUTHORIZE FOR THE SOFTWARE

OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID FOR THE SOFTWARE ($14.99 USD).

---

## 11. Indemnification

You agree to indemnify and hold harmless KUP Solutions from any claims, damages, losses, or expenses arising from your use of the Software, your violation of these Terms, or your violation of any third-party rights.

---

## 12. Termination

We may terminate your license if you violate these Terms. Upon termination, you must cease all use of the Software and destroy all copies. Sections 6, 9, 10, 11, and 14 survive termination.

---

## 13. Modifications to Terms

We may update these Terms from time to time. Updated Terms will be posted at [kup.solutions/terms](https://kup.solutions/terms). Your continued use of the Software after changes constitutes acceptance of the updated Terms.

---

## 14. Governing Law

These Terms are governed by the laws of the State of South Dakota, USA, without regard to conflict of law principles. Any disputes arising from these Terms or your use of the Software shall be resolved in the courts located in Minnehaha County, South Dakota.
