...
#   compile macOS 26).
# 2026-09-12: 4047 → 4051 (+4) — #262/#264 LIVE fail beyond PR #271.
#   WindowServer yield-before-create + UN ALWAYS_ALLOW is presentBody /
#   refuses .notificationAlwaysAllow. +4 ConfirmLiveFailContractTests.
# 2026-09-13: 4051 → 4071 (+20) — #254 skill files catalog + materialize
#   stacked onto main after #273. Registry Skills seed binds files /
...
# 2026-09-14: 4071 → 4079 (+8) — #276 fetch_skill Files & media catalog
...
# 2026-09-21: 4010 → 4000 (−10) — CI run 35525944536 measured passed=4000,
