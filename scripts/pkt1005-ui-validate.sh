...
bridge.settings.memory.process.centerPane
bridge.settings.memory.process.intentTags
bridge.settings.memory.process.confirmButton
bridge.settings.memory.process.confirmSummary
bridge.settings.memory.process.transcriptExpand
bridge.settings.memory.process.transcriptCollapse
bridge.settings.memory.process.activityDrawer
bridge.settings.memory.process.activityDrawerToggle
bridge.settings.memory.process.activityDrawerCollapse
bridge.settings.memory.process.registryConfigureSheet
bridge.settings.memory.process.titleRename
bridge.settings.memory.process.titleCloud
bridge.settings.memory.process.dryRun
