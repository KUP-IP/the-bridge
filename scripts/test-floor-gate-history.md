...
- 2026-08-21 · bounded THREAD Messages M1 recovery · `3767 → 3771` (+4): explicit service is validated before side effects, recovered local evidence must match that service, duplicate Intent retries fail closed, and an exact existing Result can complete operator-review recovery without resending or duplicating the journal. Measured 3771 passed, 0 failed on codex/thread-m1-reactivation-v2.
