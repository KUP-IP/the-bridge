...
await runMessagesSendApprovalPolicyTests()  // issue #126: configurable messages_send on-device approval
...
await runVoiceMemoMemoryRelationMatcherTests() // cache-only Memory CONTACTS/PROJECTS/DOCS/BLOCKS attach: unique contacts, distinctive tokens, exact-title blocks
